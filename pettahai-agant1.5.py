...
def opus_orchestrator(objective, file_content=None, previous_results=None):
    ...
    if file_content:
        console.print(Panel(f"File content:\n{file_content}", title="[bold red]File Content[/bold red]", title_align="left", border_style="red"))
    messages = [
        {
            "role": "user",
            "content": [
    ...
    console.print(Panel(response_text, title=f"[bold red]Generating . . . [/bold red]", title_align="left", border_style="red", subtitle="Sending task to Pettahai 1.5 👾"))
...
def haiku_sub_agent(prompt, previous_haiku_tasks=None):
    ...
    console.print(Panel(response_text, title="[bold blue]Haiku Sub-agent Result[/bold blue]", title_align="left", border_style="blue", subtitle="Task completed, sending result to Pettahai 02 👾"))
    return response_text

def opus_refine(objective, sub_task_results, filename, projectname):
  print("\nCalling pettahai 3 to provide the refined final output for your objective 📋:")
  messages = [
      {
          "role": "user",
          "content": [
  ...
  response_text = opus_response.content[0].text
  console.print(Panel(response_text, title="[bold red]Final Output[/bold red]", title_align="left", border_style="red"))
  return response_text
...
def new_func():
    ...
    for char in text:
        ...
        time.sleep(0.1)
    print()
    text = "💢 Powerd by : Pettah AI ( www.pettahai.com )"
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()
    ...
    for char in text:
        ...
        time.sleep(0.1)
    print()
    text = "💢 Developer: Seja menath de silva "
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()
    ...
    for char in text:
        ...
        time.sleep(0.1)
    print()
    text = "💢 2024 Pettah Ai all rights reserved."
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()
    ...
    for char in text:
        ...
        time.sleep(0.1)
    print()
    text = "🔘 Give you the required object."
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()

    text = "🔘 Then I pass it to pettahai.1.5 and split it into several parts and pass it  to pettahai 02 and create all the required objects.  "
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()

    text = "🔘 After that I can save this with the name of the relevant object. "
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()
    text = "🔘 If you require any coding, I can write it in the file format related to that language and put it in a separate folder for you."
    for char in text:
        print(char, end='', flush=True)
        time.sleep(0.1)
    print()
...
objective = input("👾 Please enter your objective here: ")
...
filename = f"{timestamp}_{truncated_objective}.txt"
...
input("👾 Object successfully !, you can now remove it.  Use it as exit and enter.")